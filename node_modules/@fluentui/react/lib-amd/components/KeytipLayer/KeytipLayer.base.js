    ...
    var KeytipLayerBase = /** @class */ (function (_super) {
        ...
        KeytipLayerBase.prototype._getVisibleKeytips = function (keytips) {
            ...
            return keytips.filter(function (keytip) {
                ...
                var targetSelector = (0, KeytipUtils_1.ktpTargetFromSequences)(keytip.keySequences);
                ...
                if (matchingElements.length > 1 && seenIds[keytipId] <= matchingElements.length) {
                    return keytip.visible && (0, Utilities_1.isElementVisibleAndNotHidden)(matchingElements[seenIds[keytipId] - 1]);
                }
